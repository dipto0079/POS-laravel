...
class CreateRestaurantSalesHoldsDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_restaurant_sales_holds_details', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('tbl_restaurant_sales_holds_details');
    }
}
