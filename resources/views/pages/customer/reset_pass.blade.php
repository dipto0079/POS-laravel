                    ...
                    <div class="box-grey rounded">
                        <div class="section-label bottom20">
                            <a class="section-label-a">
                                ...
                                <span class="bold" style="background:#fff;"> Forgot Password</span> <b></b>
                            </a>
                        </div>
                        <form id="forms" class="forms" method="POST" action="{{ route('reset-pass') }}">
                            @csrf
                            <div class="row top10">
                                <div class="col-md-12">
                            ...
                            <div class="row top15">
                                <div class="col-md-6">
                                    <input type="submit" value="Send Password Reset Link" class="theme-button medium full-width">
                                </div>
                            </div>
                        </form>
                    </div>
