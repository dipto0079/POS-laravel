                            ...
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input tabindex="1" type="text" name="in_time" id="in_time" class="form-control"
                                                   placeholder="In time" value="{{old('in_time')}}">
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input tabindex="1" type="text" name="out_time" id="out_time" class="form-control"
                                                   placeholder="Out time" value="{{old('out_time')}}" autocomplete="off">
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select tabindex="3" class="form-control select2" name="employee_id" style="width: 100%;">
                                                ...
                                                @foreach ($employees as $employee)
                                                    <option value="{{$employee->id}}" @if ($employee->id == old('employee_id')) selected @endif>{{$employee->manager_name .' | '. $employee->role .' | '. $employee->manager_phone}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label>Note</label>
                                            <textarea tabindex="5" class="form-control" rows="4" name="note" placeholder="Note ...">{{old('note')}}</textarea>
