                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body table-responsive">
                            <div class="row">
                                ...
                                <form id="filter_expense_form" method="get" action="{{route('attendances.filter')}}">
                                    <div class="col-md-2 form-group">
                                ...
                                <div class="col-md-5 text-right">
                                    <ul class="list-inline text-right">
                                        ...
                                        <li>
                                            <a href="{{route('attendances.create')}}"><button type="button" class="btn btn-block btn-primary pull-right">Add Attendance</button></a>
                                        </li>
                                    </ul>
                                </div>
                            </div> 
                                    ...
                                    @if (count($attendances)> 0)
                                        ...
                                        @foreach($attendances as $k=>$v)
                                            <tr>
                                                ...
                                                {{-- <td class="text-center">{{$v->manager_name}}</td> --}}
                                                <td class="text-center">{{$v->in_time}}</td>
                                                <td class="text-center">{{$v->out_time}}</td>
                                                <td class="text-center">
                                                    <a class="edit-link" role="button" href="{{route('attendances.edit', [$v->id])}}">Update Time</a>
                                                </td>
                                                <td class="text-center">{{number_format(\Carbon\Carbon::parse($v->out_time)->floatDiffInHours(\Carbon\Carbon::parse($v->in_time)),2)}} Hours</td>
                                                    ...
                                                    <div class="btn-group">
                                                        ...
                                                        <div
                                                            class="dropdown-menu dropdown-menu-right dropdown-menu-lg-left">
                                                                <a class="dropdown-item edit-link delete-attendance"
