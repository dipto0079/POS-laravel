                        ...
                        <div class="box-body table-responsive">
                            ...
                            <div class="d-flex justify-content-end" style="padding: 10px 0 30px 0">
                                <a role="button" class="btn btn-primary"
                                   href="{{route('expense-items.create')}}">Add Expense Item
                                </a>
                            </div>
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <div
                                                        ...
                                                        <a class="dropdown-item edit-link" role="button"
                                                           href="{{route('expense-items.edit', [$v->id])}}">Edit</a>
                                                        |
                                                        <a class="dropdown-item delete-expense-item"
...
@section('script')
    ...
    <script src="{!! $baseURL.'resources/assets/js/custom/restaurant/expenseItems.js'!!}"></script>
