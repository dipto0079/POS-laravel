 ...
 */ 
    ...
    if(count($getUnReadyOrders)>0){
        ...
        foreach($getUnReadyOrders as $singleOrder){
            // dd($singleOrder);
            if (count($singleOrder->salesDetails) > 0) {
            // if ($singleOrder->id == 15) {
                ...
                if($singleOrder->order_type==1){
                    ...
                    $order_name = "T ".$singleOrder->sale_no;
                }elseif($singleOrder->order_type==3){
                    $order_type = "Delivery";
                    $order_name = "DL ".$singleOrder->sale_no;
                }
                $tables_booked = '';
    
                if($singleOrder->table != null){
                    $tables_booked = $singleOrder->table->name;
                }else{
                    $tables_booked = 'None';
                }
    
                $to_time = strtotime(date('Y-m-d H:i:s'));
                $from_time = strtotime($singleOrder->processing_date_time);
                ...
                // dd([$total_kitchen_type_items, $total_kitchen_type_done_items]);
                    ...
                    $show_all_orders .= '<div class="fix floatleft single_order" data-order-type="'.$order_type.'" data-selected="'.$selected_unselected.'" id="single_order_'.$singleOrder->sale_id.'">';
                        $show_all_orders .= '<div class="header_portion light-blue-background fix">';
                            $show_all_orders .= '<div class="fix floatleft" style="width:70%;">';
                                ...
                                // $show_all_orders .= '<p class="order_number">waiter_name: '.$singleOrder->waiter->manager_name.'</p> ';
                        ...
                        $items = $singleOrder->salesDetails->sortBy('delay_time');
                        ...
                        foreach($items as $single_item){
                            if ($single_item->delay_time  == 0 || $single_item->delay_time  == null ) {
                                ...
                                $processing_delay_time = date("Y-m-d H:i:s", strtotime($singleOrder->processing_date_time . "$single_item->delay_time minutes"));
                                $ct = date("Y-m-d H:i:s");
    
                                //here need to after first menu
...
<head>
    ...
    <link rel="stylesheet" type="text/css"
        href="<?php echo $baseURL; ?>assets/kitchen_panel/css/kitchen_new_style.css">
    <link href="https://fonts.googleapis.com/css?family=Yantramanav" rel="stylesheet">
    <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.4.2/css/all.css">
    <link href="https://fonts.googleapis.com/css?family=Lobster" rel="stylesheet">
    <link rel="stylesheet" type="text/css" href="<?php echo $baseURL; ?>assets/kitchen_panel/css/sweetalert2.min.css">
    ...
    <script src="<?php echo $baseURL?>assets/kitchen_panel/js/jquery-3.3.1.min.js"></script>
    <script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script>
    <script type="text/javascript" src="<?php echo $baseURL; ?>assets/kitchen_panel/js/jquery.slimscroll.min.js">
    </script>
    <script type="text/javascript" src="<?php echo $baseURL; ?>assets/kitchen_panel/js/sweetalert2.all.min.js">
    </script>
    ...
    <base data-currency="$">
    <base data-role="{{Auth::guard('restaurantUser')->user()->role }}">
    <base data-kitchen-panel-id="{{$kitchen->id}}">
...
<body>
    ...
    <span style="display:none" id="refresh_it_or_not"><?php echo "yes"; ?></span>
    <div class="wrapper fix">
        <div class="fix main_top">
            ...
            <div class="fix floatleft top_menu">
                ...
                <a href="<?php echo $baseURL; ?>restaurant/logout" class="c-btn d-flx" id="logout_button">
                ...
                <button id="notification_button" class="c-btn d-flx">
                    ...
                    Notification(<span id="notification_counter"><?php echo $notification_number; ?></span>)
                </button>
                ...
                <a href="<?php echo $baseURL; ?>restaurant/kitchen/all-panels" class="c-btn same-btn">
                <i class="fas fas-caret-square-left"></i>Back</a>
    ...
    <div id="help_modal" class="modal">
        ...
        <div class="modal-content" id="modal_help_content">
            ...
            <!-- <img class="close_button" src="<?php echo $baseURL;?>assets/images/close_icon.png"> -->
            <h1 class="main_header"><?php echo 'help'; ?></h1>
            <p class="help_content">
                <?php echo 'kitchen_help_text_first_para'; ?> <br/>
                <?php echo 'kitchen_help_text_second_para'; ?><br />
                <?php echo 'kitchen_help_text_third_para'; ?>
            </p>
        </div>
    ...
    <div id="notification_list_modal" class="modal">
        ...
        <div class="modal-content" id="modal_notification_list_details">
            ...
            <div id="notification_close_delete_button_holder">
                <button id="notification_remove_all">Remove</button><button
                    id="notification_close">Close</button>
            </div>
        </div>

    </div>
    <!-- end of notification list modal -->
    <script type="text/javascript" src="<?php echo $baseURL; ?>assets/kitchen_panel/js/marquee.js"></script>
    <script type="text/javascript" src="<?php echo $baseURL; ?>assets/kitchen_panel/js/datable.js"></script>
    <script type="text/javascript" src="<?php echo $baseURL; ?>assets/kitchen_panel/js/jquery.cookie.js"></script>
    <script type="text/javascript" src="<?php echo $baseURL; ?>assets/kitchen_panel/js/custom.js"></script>
