            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li role="presentation"><a href="#paystack" aria-controls="paystack" role="tab" data-toggle="tab">Paystack</a>
                        </li>
                        <li role="presentation"><a href="#razorpay" aria-controls="razorpay" role="tab" data-toggle="tab">Razorpay</a>
                        </li>
                    </ul>

                    <!-- Tab panes -->
                    <div>
                        <form method="post" action="{{route('add-payment-gateway')}}">
                            @csrf
                            <div class="tab-content">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" name="usb" class="form-control"
                                                   value="{{$alldata->usb}}" placeholder="USB">
                                        </div>
                                    </div>
                                </div>
                                <div role="tabpanel" class="tab-pane" id="paypal">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" name="paypal_username" value="{{$alldata->paypal_username}}" class="form-control"
                                                   placeholder="Paypal Username">
                                        </div>
                                        <div class="col-md-12">
                                            <label>Paypal Password</label>
                                            <input type="text" name="paypal_password" value="{{$alldata->paypal_password}}" class="form-control"
                                                   placeholder="Paypal Password">
                                        </div>
                                        <div class="col-md-12">
                                            <label>Paypal Signature</label>
                                            <input type="text" name="paypal_sinature" value="{{$alldata->paypal_sinature}}" class="form-control"
                                                   placeholder="Paypal Signature">
                                        </div>
                                        <div class="col-md-12">
                                            <label>Paypal Email</label>
                                            <input type="text" name="paypal_email" value="{{$alldata->paypal_email}}" class="form-control"
                                                   placeholder="Name">
                                        </div>
                                    </div>
                                </div>
                                <div role="tabpanel" class="tab-pane" id="stripe">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" name="stripe_secret" value="{{$alldata->stripe_secret}}" class="form-control"
                                ...
                                <div role="tabpanel" class="tab-pane" id="payumoney">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" name="payumoney_key" value="{{$alldata->payumoney_key}}" class="form-control"
                                                   placeholder="Payumoney Key">
                                        </div>
                                        <div class="col-md-12">
                                            <label>Payumoney Salt</label>
                                            <input type="text" name="payumoney_salt" value="{{$alldata->payumoney_salt}}" class="form-control"
                                ...
                                <div role="tabpanel" class="tab-pane" id="paystack">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" name="paystack_secret_key" value="{{$alldata->paystack_secret_key}}" class="form-control"
                                ...
                                <div role="tabpanel" class="tab-pane" id="razorpay">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <label>Key Id</label>
                                            <input type="text" name="rezorpay_key_id" value="{{$alldata->rezorpay_key_id}}" class="form-control"
                                                   placeholder="Key Id">
                                        </div>
                                        <div class="col-md-12">
                                            <label>Key Secret</label>
                                            <input type="text" name="rezorpay_key_secret" value="{{$alldata->rezorpay_key_secret}}" class="form-control"
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <form method="post" action="{{route('active-payment-gateway')}}">
                            @csrf
                            <div class="row">
                                <label>Active Gateway</label>
                                <div class="col-md-12">
                                    <label><input type="checkbox" @php echo $alldata->usb_status=='1'?'checked':'' @endphp   name="usb_status" style="cursor: pointer" class="restaurant_third_party_vendor_availability"><span>&nbsp;&nbsp;</span>Cash</label>
                                </div>
                                <div class="col-md-12">
