                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input tabindex="1" type="text" name="name" class="form-control"
                                                   placeholder="Name" value="{{$ingredient->name}}">
                                        </div>
                                            ...
                                            <select tabindex="2" class="form-control select2" name="category"
                                                ...
                                                @if(count($categories) > 0)
                                                    @foreach($categories as $k=>$v)
                                                        <option value="{{$v->id}}"
                                                                @if($ingredient->category_id === $v->id) selected @endif>{{$v->name}}</option>
                                                    @endforeach
                                                @endif
                                            </select>
                                        </div>
                                            ...
                                            <select tabindex="2" class="form-control select2" name="unit"
                                                ...
                                                @if(count($units) > 0)
                                                    @foreach($units as $k=>$v)
                                                        <option value="{{$v->id}}"
                                                                @if($ingredient->unit_id === $v->id) selected @endif>{{$v->name}}</option>
                                                    @endforeach
                                                @endif
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input tabindex="1" type="text" name="purchase_price" class="form-control"
                                                   placeholder="1.00" value="{{$ingredient->purchase_price}}">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input tabindex="1" type="text" name="alert_quantity" class="form-control"
                                                   placeholder="1.00" value="{{$ingredient->alert_quantity}}">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input tabindex="1" type="text" name="code" class="form-control"
                                                   placeholder="Code" value="{{$ingredient->code}}">
                                        </div>
