            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        <!-- form start -->
                        <form method="post" action="{{route('ingredient-units.update', [$unit->id])}}">
                            @csrf
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input tabindex="1" type="text" name="description" class="form-control"
                                                   placeholder="Description" value="{{$unit->description}}">
                                        </div>
                            ...
                            <div class="box-footer">
                                ...
                                <a href="{{route('ingredient-units.index')}}" role="button"
