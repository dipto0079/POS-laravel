                        ...
                        <div class="box-body table-responsive">
                            ...
                            <div class="d-flex justify-content-end" style="padding: 10px 0 30px 0">
                                <a role="button" class="btn btn-primary"
                                   href="{{route('ingredient-units.create')}}">Add Ingredient Unit
                                </a>
                            </div>
                            <table id="datatable" class="table table-striped">
                                ...
                                <tr>
                                    ...
                                    <th class="title" style="width: 25%">Unit Name</th>
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <div
                                                        ...
                                                        <a class="dropdown-item edit-link" role="button"
                                                           href="{{route('ingredient-units.edit', [$v->id])}}">Edit</a>
                                                        |
...
@section('script')
    ...
    <script src="{!! $baseURL.'resources/assets/js/custom/restaurant/ingredientUnits.js'!!}"></script>
@endsection
