            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        <!-- form start -->
                        <form method="post" action="{{route('purchases.store')}}" id="purchase_form">
                            @csrf
                            <div class="box-body">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input tabindex="3" readonly type="text" id="date" name="date"
                                                   class="form-control purchase-datepicker" placeholder="Date"
                                                   value="{{date('Y-m-d')}}">
                                        </div>
                                        @if ($errors->has('date'))
                                            <div class="alert alert-error" style="padding: 5px !important;">
                                            ...
                                            <table style="width: 100%">
                                                <tr>
                                                    <td><input tabindex="3" class="form-control integerchk" type="text"
                                                               ...
                                                               onkeyup="return calculateAll()" value="">
                                                    </td>
                                                    <td style="width: 5%;text-align: right"> <span
                                                            class="label_aligning_total_loss">
