                            ...
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input tabindex="1" type="text" name="apt" class="form-control"
                                                   placeholder="Apt." value="{{$customer->apt}}">
                                        </div>
                                            ...
                                            <select tabindex="1" class="form-control select2" name="country"
                                                ...
                                                @if(count($countries) > 0)
                                                    @foreach($countries as $k=>$v)
                                                        <option value="{{$v->id}}"
                                                                @if($customer->country_id === $v->id) selected @endif>{{$v->name}}</option>
                                                    @endforeach
                                                @endif
                                            </select>
                                        ...
                                        <div class="col-md-4 form-group">
                                            ...
                                            <select tabindex="1" class="form-control select2" name="state"
                                                ...
                                                @if($customer->state_id)
                                                    <option
                                                        value="{{$customer->state_id}}" selected>{!! getStateNameById($customer->state_id) !!}</option>
                                                @endif
                                            </select>
                                            @if ($errors->has('state'))
                                                <div class="alert alert-error" style="padding: 5px !important;">
                                        ...
                                        <div class="col-md-4 form-group">
                                            ...
                                            <select tabindex="1" class="form-control select2" name="city" id="city"
                                                ...
                                                @if($customer->city_id)
                                                    <option
                                                        value="{{$customer->city_id}}" selected>{!! getCityNameById($customer->city_id) !!}</option>
                                                @endif
                                            </select>
                                            @if ($errors->has('city'))
                                                <div class="alert alert-error" style="padding: 5px !important;">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input tabindex="1" type="text" name="zip" class="form-control"
                                                   placeholder="Zip" value="{{$customer->zip}}">
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <label>Note</label>
                                            <textarea name="note" class="form-control" rows="10">{{$customer->note}}</textarea>
                                        </div>
                                        ...
                                        <select tabindex="1" class="form-control select2" name="customer_group"
                                            ...
                                            @if(count($customerGroups) > 0)
                                                @foreach($customerGroups as $k=>$v)
                                                    <option value="{{$v->id}}" @if($customer->customer_group_id == $v->id) selected @endif>{{$v->name}}({{$v->discount_percentage}}%)</option>
                                                @endforeach
                                            @endif
                                        </select>
