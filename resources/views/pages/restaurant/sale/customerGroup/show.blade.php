            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <label for="customer_group">CODE:</label>
                        <h3 id="customer_group">@php echo base64_encode($customerGroup->id); @endphp  </h3>



                            <label for="customer_group">Coustomer Group:</label>
                            <h3 id="customer_group"> {{$customerGroup->name}} </h3>
                            <div class="d-flex justify-content-end" style="padding: 10px 0 30px 0">
                                ...
                                <label for="discount_percentage">Default Discount Percentage :</label>
                                <p id="discount_percentage"> {{$customerGroup->discount_percentage}}%</p>
                                <label for="description">Description :</label>
                                <p id="description"> {{$customerGroup->description}}</p>
                            </div>
                            <table id="datatable" class="table table-striped">
                                ...
                                <tbody>
                                    @if(count($customerGroup->customers) > 0)
                                        @foreach($customerGroup->customers as $k=>$v)
                                            <tr>
                                                <th scope="row">{{$k + 1}}</th>
                                                <td>{{$v->name}}</td>
                                                <td>{{$v->email}}</td>
