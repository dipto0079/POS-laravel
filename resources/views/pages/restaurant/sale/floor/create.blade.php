            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        <!-- form start -->
                        <form method="post" action="{{route('floors.store')}}" id="floorDesign">
                            @csrf
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <div class="container">
                                                <!-- <div id="toolbar" class="controls-wrapper clearfix">
                                                    <div class="controls">
                                                    Line Width: <span id="lineWidthLabel" class="line-width-value">16</span>
                                                    <div id="lineWidthUp" class="line-width-control">+</div>
                                                    <div id="lineWidthDown" class="line-width-control">-</div>
                                                    </div>
                                                </div> -->
                                                <!-- /#toolbar-->
