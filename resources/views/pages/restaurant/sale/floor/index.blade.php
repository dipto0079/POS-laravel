                        ...
                        <div class="box-body table-responsive">
                            ...
                            <div class="d-flex justify-content-end" style="padding: 10px 0 30px 0">
                                <a role="button" class="btn btn-primary"
                                   href="{{route('floors.create')}}">Add Floor
                                </a>
                            </div>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        ...
                                                        <div
                                                            ...
                                                            href="{{route('floors.show', [$v->id])}}">View
                                                                Details</a>
                                                            <a class="btn btn-warning" role="button"
                                                               href="{{route('floors.edit', [$v->id])}}">Edit</a>
                                                            <a class="btn btn-danger delete-floor"
                                                            role="button" data-id="{{$v->id}}">Delete</a>
                                                            <a class="btn btn-info"
                                                            role="button" href="{{route('floor-tables.create', [$v->id])}}">Add Table</a>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
...
@section('script')
    ...
    <script src="{!! $baseURL.'resources/assets/js/custom/restaurant/floors.js'!!}"></script>
@endsection
