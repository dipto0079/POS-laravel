            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        <!-- form start -->
                        <form method="post" action="{{route('food-menu.update-assign-modifier', [$food_menu_details->id])}}"
                              id="food_menu_form" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="box-body">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        $checked='';
                                        if (!empty($food_menu_modifiers_list)) {
                                            foreach ($food_menu_modifiers_list as $fmm) {
                                                if (in_array($modifier_id_, $food_menu_modifiers_list)) {
                                                    $checked = 'checked';
                                                } else {
                                                    $checked = '';
                                                }
                                        ...
                                        <label class="container"><?= $modifier->name ?>
                                            <input type="checkbox" class="checkbox_user"
                                                   <?= $checked ?> value="<?= $modifier->id ?>" name="modifier_id[]">
                                            <span class="checkmark"></span>
                                        </label>
                                        <?php
                                        }
                                ...
                                <div class="box-footer">
                                    ...
                                    <a href="{{route('food-menu.index')}}"><button type="button" class="btn
                            btn-primary">back</button></a>
                                </div>
                            </div>
                        </form>
                    </div>
        ...
        if (!empty($food_menu_modifiers)) {
            ...
            if ($food_menu_modifiers && !empty($food_menu_modifiers)) {
                foreach ($food_menu_modifiers as $fmm) {
                    $modifier_id_container .= '"' . $fmm->mdf_id . '",';
                }
            }
