                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body table-responsive">
                            <h3>Food Menu Modifier</h3>
                            <div class="d-flex justify-content-end" style="padding: 10px 0 30px 0">
                                <a role="button" class="btn btn-primary"
                                   href="{{route('food-menu-modifiers.create')}}">Add Food Menu Modifier
                                </a>
                            </div>
                            <table id="datatable" class="table table-striped">
                                ...
                                <tr>
                                    ...
                                    <th class="title" style="width: 10%">Price</th>
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <div
                                                        ...
                                                        <a class="dropdown-item edit-link" role="button"
                                                           href="{{route('food-menu-modifiers.show', [$v->id])}}">View Details</a> |
                                                        <a class="dropdown-item edit-link" role="button"
                                                           href="{{route('food-menu-modifiers.edit', [$v->id])}}">Edit</a>
                                                        |
