                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body table-responsive">
                            <h3>Food Menu Shifts</h3>
                            <div class="d-flex justify-content-end" style="padding: 10px 0 30px 0">
                                <a role="button" class="btn btn-primary"
                                   href="{{route('food-menu-shifts.create')}}">Add Food Menu Shift
                                </a>
                            </div>
                            <table id="datatable" class="table table-striped">
                                ...
                                <tr>
                                    ...
                                    <th class="title" style="width: 25%">Starting Time</th>
                                    <th class="title" style="width: 25%">EndingTime</th>
                                ...
                                @if(count($shifts) > 0)
                                    @foreach($shifts as $k=>$v)
                                        <tr>
                                            <th scope="row">{{$k + 1}}</th>
                                            <td>{{$v->name}}</td>
                                            <td>{{date('h:i A', strtotime($v->starting_time)) }}</td>
                                            <td>{{date('h:i A', strtotime($v->ending_time)) }}</td>
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <div
                                                        ...
                                                        <a class="dropdown-item edit-link" role="button"
                                                           href="{{route('food-menu-shifts.edit', [$v->id])}}">Edit</a>
                                                        |
...
@section('script')
    ...
    <script src="{!! $baseURL.'resources/assets/js/custom/restaurant/shifts.js'!!}"></script>
@endsection
