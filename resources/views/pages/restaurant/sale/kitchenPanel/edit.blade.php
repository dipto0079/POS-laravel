            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        <!-- form start -->
                        <form method="post" action="{{route('kitchen-panels.update', [$kitchen->id])}}">
                            @csrf
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input tabindex="1" type="text" name="name" class="form-control"
                                                   placeholder="Name" value="{{$kitchen->name}}">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input tabindex="1" type="text" name="description" class="form-control"
                                                   placeholder="Description" value="{{$kitchen->description}}">
                                        </div>
                            ...
                            <div class="box-footer">
                                ...
                                <a href="{{route('kitchen-panels.index')}}" role="button" class="btn btn-primary">Back
                                </a>
                            </div>
                        </form>
                    </div>
