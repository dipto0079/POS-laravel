                ...
                <div id="receipt-data">
                    <div class="text-center">
                        ...
                        <p>
                            ...
                            @if ($restaurant->taxSettings && $restaurant->taxSettings->collect_tax == 'Yes')
                                <br>
                                {{$restaurant->taxSettings->reg_no}}
                            @endif
                    ...
                    <p>Date: <?= date('d-m-yy', strtotime($sale_object->sale_date)); ?> <?= date('H:i',strtotime($sale_object->order_time)) ?><br>
                        ...
                        <br/>Phone: {{$sale_object->customer->phone}}
                        @if ($sale_object->customer->address != NULL  && $sale_object->customer->address!="")
                            <br/>Address: {{$sale_object->customer->address}}
                        @endif
                        <br/>Zip Code: {{$sale_object->customer->zip}}
                    ...
                    <table class="table table-condensed">
                        ...
                        <tfoot>
                            ...
                            <tr>
                                <th>Paid Amount</th>
                                <th class="text-right"><?php echo "$" . number_format($sale_object->paid_amount, 2); ?></th>
                            </tr>
                            <tr>
                                <th>Due Amount</th>
                                <th class="text-right"><?php echo "$" . number_format($sale_object->due_amount, 2); ?></th>
                            </tr>
                        </tfoot>
                    </table>
