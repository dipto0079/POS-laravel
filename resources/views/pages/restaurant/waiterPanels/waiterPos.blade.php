@php
    ...
    foreach($food_menus as $single_menus){
        ...
        if($total_menus==$i){
            $javascript_obects .= "{item_id:'".$single_menus->id."',item_code:'".$single_menus->code."',category_name:'".$single_menus->categoryInfo->name."',item_name:'".$single_menus->name."',price:'$".$single_menus->dine_in_price."',t_price:'$".$single_menus->take_away_price."',dl_price:'$".$single_menus->delivery_order_price."',image:'".$image_path."',tax_information:'".$single_menus->tax_info."',vat_percentage:'".$single_menus->percentage."',veg_item:'".$veg_status."',beverage_item:'',bar_item:'',sold_for:'".$single_menus->item_sold."',modifiers:[".$modifiers."]}";
        }else{
            $javascript_obects .= "{item_id:'".$single_menus->id."',item_code:'".$single_menus->code."',category_name:'".$single_menus->categoryInfo->name."',item_name:'".$single_menus->name."',price:'$".$single_menus->dine_in_price."',t_price:'$".$single_menus->take_away_price."',dl_price:'$".$single_menus->delivery_order_price."',image:'".$image_path."',tax_information:'".$single_menus->tax_info."',vat_percentage:'".$single_menus->percentage."',veg_item:'".$veg_status."',beverage_item:'',bar_item:'',sold_for:'".$single_menus->item_sold."',modifiers:[".$modifiers."]},";
        }
    ...
    foreach ($waiters as $waiter){
        if (Auth::guard('restaurantUser')->id() == $waiter->id) {
            $user_role = Auth::guard('restaurantUser')->user()->role;
            $waiters_option = '<option value="'.$waiter->id.'" selected >'.$waiter->manager_name.'</option>';
            // dd($waiters_option);
            break;
        } else {
            if($waiter->manager_name=='Default Waiter'){
                $waiters_option = '<option value="'.$waiter->id.'">'.$waiter->manager_name.'</option>'.$waiters_option;
            }else{
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo $baseURL; ?>assets/waiter_panel/css/style.css">
    <link href="https://fonts.googleapis.com/css?family=Yantramanav" rel="stylesheet">
    <link rel="stylesheet" href="<?php echo $baseURL; ?>assets/waiter_panel/css/font_awesome_all.css">
    ...
    <link rel="stylesheet" href="<?php echo $baseURL; ?>assets/waiter_panel/css/jquery-ui.css">
    <script src="<?php echo $baseURL?>assets/waiter_panel/js/jquery-3.3.1.min.js"></script>
    <script src="<?php echo $baseURL?>assets/waiter_panel/js/jquery-ui.js"></script>
    <script type="text/javascript"
            src="<?php echo $baseURL; ?>assets/waiter_panel/js/jquery.slimscroll.min.js"></script>
    <!-- Sweet alert -->
    <script src="<?php echo $baseURL; ?>assets/waiter_panel/sweetalert2/dist/sweetalert.min.js"></script>
    <link rel="stylesheet" href="<?php echo $baseURL; ?>assets/waiter_panel/sweetalert2/dist/sweetalert.min.css">

    <script type="text/javascript"
            src="<?php echo $baseURL; ?>assets/bower_components/select2/dist/js/select2.full.min.js"></script>
    <script type="text/javascript" src="<?php echo $baseURL; ?>assets/waiter_panel/js/calculator.js"></script>

    <base data-base="<?php echo $baseURL; ?>">
    <base data-currency="$">
    <base data-shift="<?php echo $shift_id; ?>">
    <base data-role="<?php echo $user_role; ?>">
...
<div class="wrapper fix">
    <div class="top_header_part fix">
        ...
        <div class="header_part_left fix">
            ...
            <button id="calculator_button" style="margin-right: 3px;"><i class="fas fa-calculator"></i> Calculator
            </button>
        ...
        <div class="header_part_right fix">
            <div class="header_single_button_holder" style="width:15%">
                <button style="float:left;" id="last_ten_sales_button" disabled><i class="fas fa-history"></i> Last 10
                    sales
                </button>
            </div>

            <div style="text-align:center;width:22%;" class="header_single_button_holder">
                <button id="notification_button"><i class="fas fa-bell"></i> kitchen notification (<span
                        id="notification_counter">{{$notification_number}}</span>)
                </button>
            </div>


            <div style="text-align:center;width:18%;" class="header_single_button_holder">
                <button id="onlineOrder_btn" disabled>
            ...
            <div class="header_single_button_holder" style="width:14%;">
                <a href="#" id="register_close">
                    <button style="float:right;" disabled><i class="fas fa-times"></i> Register</button>
                </a>
            </div>
            <div class="header_single_button_holder" style="width:17%; ">
                <a href="#" id="go_to_dashboard">
                    <button style="float:right;"><i class="fas fa-caret-square-left"></i>
                        <?php
            ...
            <div class="header_single_button_holder" style="width:14%">
                <a href="<?php echo $baseURL; ?>restaurant/logout">
                    <button style="float:right;"><i class="fas fa-sign-out-alt"></i> Logout</button>
                </a>
            </div>
    ...
    <div id="main_part fix" style="display:flex; justify-content: space-between;">
        <div class="main_left fix">
            <div class="holder fix">
                <div id="running_order_header">
                    ...
                    <input type="text" name="search_running_orders" id="search_running_orders" autocomplete='off'
                           style="height: 15px;margin: 0px 0px 0px 5px;width: 90%;"
                           placeholder="Customer, Waiter, Order, Table"/>
                </div>
                ...
                <div style="position: absolute;bottom: 8px;width:100%;" id="left_side_button_holder_absolute">
                    ...
                    <button class="operation_button fix" id="modify_order"><i class="fas fa-edit"></i> Modify Order
                    </button>
                    <?php } ?>
                    <button class="operation_button fix" id="single_order_details"><i class="fas fa-info-circle"></i>
                        Order Details
                    </button>
                    ...
                    <div style="display:flex;justify-content:space-between;position:relative;">
                        <button style="margin-bottom:5px;" class="operation_button fix" id="create_bill_and_close">
                            Bill
                        </button>
                        <div class="billToolTip">Print Bill for Customer Before Invoicing</div>
                    </div>
                    <button class="operation_button fix" id="kitchen_status_button"><i class="fas fa-spinner"></i>
                        Kitchen Status
                    </button>
                </div>
            ...
            <div class="main_top fix">
                <div class="button_holder fix">
                    <div class="single_button_middle_holder fix">
                        <button data-selected="unselected" style="float:left;margin-left:2px;" id="dine_in_button"><i
                                class="fas fa-table"></i> Dine In
                        </button>
                    </div>
                    ...
                    <div class="single_button_middle_holder fix">
                        <button data-selected="unselected" style="float:right;" id="delivery_button"><i
            ...
            <div style="position: absolute;bottom: -7px;width: 100%" id="bottom_absolute">
                ...
                <table cellspacing="0" cellpadding="0">
                    ...
                    <tr style="background-color:#F7FAFC;">
                        <td style="padding-left:10px;font-weight:bold;text-align:left;">Total Item: <span
                                id="total_items_in_cart_with_quantity">0</span> <span id="total_items_in_cart"
                                                                                      style="display: none;">0</span>
                        </td>
                        <td style="font-weight:bold;text-align:right;" colspan="3">Sub Total</td>
                        <td style="font-weight:bold;text-align:right;padding-right:10px;">$ <span id="sub_total_show">0.00</span><span
                                id="sub_total" style="display:none;">0.00</span>
                            <span id="total_item_discount" style="display:none">0</span><span
                                id="discounted_sub_total_amount" style="display:none;">0.00</span></td>
                    </tr>
                    <tr style="background-color:#F7FAFC;">
                        <td style="padding-left:10px;font-weight:bold;text-align:left;">Processing Date & Time: <span
                                id="processing_date_time"></span><input type="datetime-local"
                                                                        id="hidden_processing_date_time" hidden
                                                                        value=""/></td>
                        <td style="font-weight:bold;text-align:right;" colspan="3">Discount</td>
                        <td style="text-align:right;padding-right:10px;">
                            <input type="text" name="" class="special_textbox" placeholder="Amt or %"
                                   id="sub_total_discount"/>
                            <span style="display:none" id="sub_total_discount_amount"></span>
                        </td>
                    </tr>
                    <tr style="background-color:#F7FAFC;">
                        <td style="font-weight:bold;text-align:right;padding-right:10px;" colspan="5"><span
                                id="all_items_vat" style="display: block;overflow: auto;height: 30px;"></span></td>
                    </tr>
                    <tr style="background-color:#F7FAFC;">
                        <td></td>
                        <td style="font-weight:bold;text-align:right;" colspan="3">Total Discount</td>
                        <td style="font-weight:bold;text-align:right;padding-right:10px;">$ <span
                                id="all_items_discount">0.00</span></td>
                    </tr>
                    <tr style="background-color:#F7FAFC;">
                        <td></td>
                        <td style="font-weight:bold;text-align:right;" colspan="3">Delivery Charge</td>
                        <td style="text-align:right;padding-right:10px;"><input type="" name="" class="special_textbox"
                                                                                placeholder="Amt" id="delivery_charge"/>
                        </td>
                    </tr>
                ...
                <div class="main_bottom fix" style="padding-top:2px;">
                    <div class="button_group fix">
                        <div class="single_button_middle_holder cart_bottom_buttons" style="width:17%;">
                            <button style="float:left;padding:0px 3px;" id="cancel_button"><i class="fas fa-times"></i>
                                Cancel
                            </button>
                        </div>
                        <div style="text-align:center;width:20%;"
                             class="single_button_middle_holder cart_bottom_buttons">
                            <button id="hold_sale" style="padding:0px 3px;"><i class="fas fa-hand-rock"></i></i> Hold
                            </button>
                        </div>
                        ...
                        <div class="single_button_middle_holder cart_bottom_buttons" style="width:34%;">
                            <button style="float:right;margin-right:2px;padding:0px 3px;" class="placeOrderSound"
                                    id="place_order_operation"><i class="fas fa-utensils"></i> <span
        ...
        <div class="main_right fix">
            <input type="text" name="search" id="search" autocomplete="off"
                   placeholder="Name Or Code Or Cat Or Veg Or Bev"/>
            <div class="select_category fix">
                ...
                <div class="select_category_inside">
                    <div class="select_category_inside_inside">
                        <button class="category_button" id="button_category_show_all"
                                style="border-left: solid 2px #DEDEDE;">All
                        </button>
                        @if ($categories)
                            @foreach ($categories as $category)
                                <button class="category_button" id="button_category_{{$category->id}}"
                                        style="border-left: solid 2px #DEDEDE;">{{$category->name}}</button>
                            @endforeach
                        @endif
                    </div>
    ...
    <div class="modal-content">
        ...
        <div style="margin: 0 5px;">
            <div class="section1 fix">
                ...
                <div class="sec1_inside" id="sec1_2"><i class="fas fa-minus-circle" id="decrease_item_modal"></i> <span
                        id="item_quantity_modal">1</span> <i class="fas fa-plus-circle" id="increase_item_modal"></i>
                </div>
            ...
            <div class="section2 fix">
                ...
                <div class="sec2_inside" id="sec2_2">$<span id="modal_modifier_price_variable">0</span><span
                        id="modal_modifiers_unit_price_variable" style="display: none;">0</span></div>
            </div>
            ...
            <div id="modal_discount_section">
                <p style="float: left;margin: 0px 0px 0px 2px;font-size: 16px;">Discount</p><input type="text" name=""
                                                                                                   id="modal_discount"
                                                                                                   placeholder="Amt or %"/>
            </div>
        ...
        <div class="section7 fix">
            <div class="sec7_inside" id="sec7_2">
                <button id="add_to_cart">add_to_cart</button>
            </div>
            <div class="sec7_inside" id="sec7_1">
                <button id="close_item_modal">cancel</button>
            </div>
        </div>
...
<div id="add_customer_modal" class="modal" style="padding-top:20px;">
    ...
    <div class="modal-content" id="editCustomer1">
            ...
            <div class="content">
                ...
                <div class="left-item b">
                    ...
                    <div class="customer_section fix">
                        ...
                        <select tabindex="1" class="add_customer_modal_input select2" name="country"
                    ...
                    <div class="customer_section fix">
                        ...
                        <select tabindex="1" class="add_customer_modal_input select2" name="state"
                ...
                <div class="right-item b">
                    <div class="customer_section fix">
                        ...
                        <input type="text" name="apt" class="add_customer_modal_input" id="customer_apt_number_modal"
                               placeholder="Apt.">
                    </div>
                    <div class="customer_section fix">
                        <p class="input_level">delivery_address</p>
                        <textarea id="customer_delivery_address_modal"></textarea>
                    </div>
                    <div class="customer_section fix">
                        <p class="input_level">Zip <span style="color:red;">*</span></p>
                        <input type="text" name="zip" class="add_customer_modal_input" id="customer_zip_modal"
                               placeholder="zip.">
                    </div>
                    <div class="customer_section fix">
                        <p class="input_level">Code <span style="color:red;">*</span></p>
                        <input type="text" name="code" class="add_customer_modal_input" id="customer_code_modal"
                               placeholder="zip.">
                    </div>
                    <div class="customer_section fix">
                        <p class="input_level">City</p>
                        <select tabindex="1" class="add_customer_modal_input select2" name="city" id="city"
                                style="width: 100%;">
        ...
        <div class="section7 fix">
            <div class="sec7_inside" id="sec7_2">
                <button id="add_customer">Submit</button>
            </div>
            <div class="sec7_inside" id="sec7_1">
                <button id="close_add_customer_modal">Cancel</button>
            </div>
        </div>
        <!-- <span class="close">&times;</span> -->
        <!-- <p>Some text in the Modal..</p> -->
...
<div id="show_tables_modal2" class="modal">
    ...
    <div class="modal-content" id="modal_content_show_tables2">
        <h1 style="position: relative">
            Tables
            <a href="javascript:void(0)" style="top: 10px;right: 20px;" class="alertCloseIcon"
               id="table_modal_cancel_button2">X</a>
        </h1>
        ...
        <div class="fix bottom_button_holder_table_modal">
            ...
            <div class="right fix floatleft half">
                <button class="floatright" id="submit_table_modal">Done</button>
                    ...
                    <div class="top fix">
                        <div class="top_middle fix">
                            ...
                            <div class="waiter_customer_table fix">
                                <div class="fix order_type"><span style="font-weight: bold;">Order Type: </span><span
                                        id="hold_order_type"></span><span id="hold_order_type_id"
                                                                          style="display:none;"></span></div>
                            </div>
                            <div class="waiter_customer_table fix">
                                <div class="waiter fix"><span style="font-weight: bold;">Waiter: </span><span
                                        style="display:none;" id="hold_waiter_id"></span><span
                                        id="hold_waiter_name"></span></div>
                                <div class="customer fix"><span style="font-weight: bold;">Customer: </span><span
                                        style="display:none;" id="hold_customer_id"></span><span
                                        id="hold_customer_name"></span></div>
                                <div class="table fix"><span style="font-weight: bold;">Table: </span><span
                                        style="display:none;" id="hold_table_id"></span><span
                            ...
                            <div class="item_modifier_details fix">
                                ...
                                <div class="bottom_total_calculation_hold fix">
                                    <div class="single_row first fix">
                                        <div class="first_column fix">Total Item: <span
                                                id="total_items_in_cart_hold">0</span></div>
                                    ...
                                    <div class="single_row second fix">
                                        ...
                                        <div class="second_column fix"><span id="sub_total_discount_hold"></span><span
                                                id="sub_total_discount_amount_hold" style="display:none;">0.00</span>
                                        </div>
                                    </div>
                                    <div class="single_row third fix">
                                        <!-- <div class="first_column fix">VAT</div> -->
                                        <div class="second_column fix" colspan="5" style="width:100%;"><span
                                                id="all_items_vat_hold"
                                                style="display: block;overflow: auto;height: 40px;">0.00</span></div>
                                    </div>
                                    <div class="single_row forth fix">
                                        <div class="first_column fix">Total Discount</div>
                                        <div class="second_column fix">$ <span id="all_items_discount_hold">0.00</span>
                                        </div>
                                    </div>
                                    <div class="single_row fifth fix">
                                        <div class="first_column fix">Delivery Charge</div>
                                        <div class="second_column fix">$ <span id="delivery_charge_hold">0.00</span>
                                        </div>
                                    </div>
                        ...
                        <div class="top_middle fix">
                            ...
                            <div class="waiter_customer_table fix">
                                <div class="fix order_type">
                                    ...
                                    <span id="last_10_order_type"
                                          style="width: 112px;display: inline-block;">&nbsp;</span>
                            ...
                            <div class="waiter_customer_table fix">
                                <div class="waiter fix"><span style="font-weight: bold;">waiter: </span><span
                                        style="display:none;" id="last_10_waiter_id"></span><span
                                        id="last_10_waiter_name"></span></div>
                                <div class="customer fix"><span style="font-weight: bold;">customer: </span><span
                                        style="display:none;" id="last_10_customer_id"></span><span
                                        id="last_10_customer_name"></span></div>
                                <div class="table fix"><span style="font-weight: bold;">table: </span><span
                                        style="display:none;" id="last_10_table_id"></span><span
                            ...
                            <div class="item_modifier_details fix">
                                ...
                                <div class="bottom_total_calculation_hold fix">
                                    <div class="single_row first fix">
                                        <div class="first_column fix">total_item: <span
                                                id="total_items_in_cart_last_10">0</span></div>
                                    ...
                                    <div class="single_row second fix">
                                        <div class="first_column fix">discount</div>
                                        <div class="second_column fix"><span
                                                id="sub_total_discount_last_10"></span><span
                                                id="sub_total_discount_amount_last_10" style="display:none;">0.00</span>
                                        </div>
                                    </div>
                                    <div class="single_row third fix">
                                        <!-- <div class="first_column fix">VAT</div> -->
                                        <div class="second_column fix" colspan="5" style="width:100%;"><span
                                                id="all_items_vat_last_10"
                                                style="display: block;overflow: auto;height: 40px;"></span></div>
                                    </div>
                                    <div class="single_row forth fix">
                                        <div class="first_column fix">total_discount</div>
                                        <div class="second_column fix">$ <span
                                                id="all_items_discount_last_10">0.00</span></div>
                                    </div>
                                    <div class="single_row fifth fix">
                                        <div class="first_column fix">delivery_charge</div>
                                        <div class="second_column fix">$ <span id="delivery_charge_last_10">0.00</span>
                                        </div>
                                    </div>
                                    <div class="single_row sixth fix">
                                        <div class="first_column fix">total_payable</div>
                                        <div class="second_column fix">$ <span id="total_payable_last_10">0.00</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<div id="generate_sale_hold_modal" class="modal">
    ...
    <div class="modal-content" id="modal_content_generate_hold_sales">
        ...
        <div class="section7 fix">
            <div class="sec7_inside" id="sec7_1">
                <button id="close_hold_modal">cancel</button>
            </div>
            <div class="sec7_inside" id="sec7_2">
                <button id="hold_cart_info">submit</button>
            </div>
        </div>
    </div>
        ...
        <div class="order_detail_modal_info_holder fix">
            <div class="top fix">
                ...
                <div class="top_middle fix">
                    ...
                    <div class="waiter_customer_table fix">
                        <div class="waiter fix"><span style="font-weight: bold;">Waiter : </span><span
                                style="display:none;" id="order_details_waiter_id"></span><span
                                id="order_details_waiter_name"></span></div>
                        <div class="customer fix"><span style="font-weight: bold;">Customer : </span><span
                                style="display:none;" id="order_details_customer_id"></span><span
                                id="order_details_customer_name"></span></div>
                        <div class="table fix"><span style="font-weight: bold;">Table : </span><span
                                style="display:none;" id="order_details_table_id"></span><span
                    ...
                    <div class="item_modifier_details fix">
                        ...
                        <div class="bottom_total_calculation_hold fix">
                            ...
                            <div class="single_row second fix">
                                <div class="first_column fix">Discount</div>
                                <div class="second_column fix"><span id="sub_total_discount_order_details"></span><span
                                        id="sub_total_discount_amount_order_details" style="display:none;">0.00</span>
                                </div>
                            </div>
                            <div class="single_row third fix">
                                <!-- <div class="first_column fix">VAT</div> -->
                                <div class="second_column fix" colspan="5" style="width:100%;"><span
                                        id="all_items_vat_order_details"
                                        style="display: block;overflow: auto;height: 40px;">0.00</span></div>
                            </div>
                            <div class="single_row forth fix">
                                <div class="first_column fix">Total Discount</div>
                                <div class="second_column fix">$ <span id="all_items_discount_order_details">0.00</span>
                                </div>
                            </div>
                            <div class="single_row fifth fix">
                                <div class="first_column fix">Delivery Charge</div>
                                <div class="second_column fix"><span id="delivery_charge_order_details">0.00</span>
                                </div>
                            </div>
                            <div class="single_row sixth fix">
                                <div class="first_column fix">Total Payable</div>
            ...
            <div class="create_invoice_close_order_in_order_details" id="order_details_pre_invoice_buttons">
                <div class="half fix floatleft textcenter">
                    <button id="order_details_create_invoice_button"><i class="fas fa-file-invoice"></i> Create Invoice
                    </button>
                </div>
                <div class="half fix floatleft textcenter">
                    <button id="order_details_close_order_button"><i class="fas fa-times-circle"></i> Close Order
                    </button>
                </div>
            </div>
            <?php } ?>
            ...
            <div class="create_invoice_close_order_in_order_details" id="order_details_post_invoice_buttons">
                <button id="order_details_create_invoice_close_order_button"><i class="fas fa-file-invoice"></i> Create
                    Invoice Close
                </button>
            </div>
            <?php } ?>
...
<div id="kitchen_status_modal" class="modal">
    ...
    <div class="modal-content" id="modal_kitchen_status_details">
        <h1 id="kitchen_status_main_header">
            Kitchen Status
            <a href="javascript:void(0)" style="top:-22px;right: 0;" class="alertCloseIcon"
               id="kitchen_status_close_button2">X</a>
        </h1>
        <div class="kitchen_status_modal_info_holder fix">
            <p><span style="font-weight:bold">Order Number:</span> <span id="kitchen_status_order_number"></span> <span
                    style="font-weight:bold">Order Type:</span> <span id="kitchen_status_order_type"></span></p>
            <p style="text-align:left;">
                <span style="font-weight:bold">Waiter: </span><span
                    id="kitchen_status_waiter_name">Tamim Shahriar</span>
                <span style="font-weight:bold">Customer: </span><span
                    id="kitchen_status_customer_name">Faruq Hussain</span>
            ...
            <h1 id="kitchen_status_time_count">Time Count: <span id="kitchen_status_ordered_minute">23</span>:<span
                    id="kitchen_status_ordered_second">55</span> M</h1>
...
<div id="finalize_order_modal" class="modal">
    ...
    <div class="modal-content" id="modal_finalize_order_details">
        <h1 id="modal_finalize_header">finalize_order</h1>
        <div class="fo_1 fix">
            <span style="display:none;" id="finalize_update_type"></span>
            <div class="half fix floatleft">total_payable</div>
        ...
        <div class="fo_3 fix">
            <div class="half fix floatleft textleft">pay_amount</div>
            <div class="half fix floatleft textright">due_amount</div>
        ...
        <div class="fo_3 fix">
            <div class="half fix floatleft textleft">given_amount</div>
            <div class="half fix floatleft textright">change_amount</div>
...
<div id="kitchen_bar_waiter_panel_button_modal" class="modal">
    ...
    <div class="modal-content" id="modal_kitchen_bar_waiter_details" style="position: relative;">
        ...
        <div style="padding:30px;">
            ...
            <a href="<?php echo $baseURL; ?>Demo_panel/switchTo/kitchen" target="_blank"
               style="width: 32%;display: inline-block;text-align: center;">
                <button style="width:100%;">kitchen_panel</button>
            </a>
            <a href="<?php echo $baseURL; ?>Demo_panel/switchTo/waiter" target="_blank"
               style="width: 32%;display: inline-block;text-align: center;">
                <button style="width:100%;">waiter_panel</button>
            </a>
            <a href="<?php echo $baseURL; ?>Demo_panel/switchTo/bar" target="_blank"
               style="width: 32%;display: inline-block;text-align: center;">
...
<div id="kot_list_modal" class="modal">
    ...
    <div class="modal-content" id="modal_kot_list_details">
        <h1 id="modal_kot_header">
            Kot
            <a href="javascript:void(0)" style="top: 5px;right:10px;" class="alertCloseIcon"
               id="cancel_kot_modal2">X</a>
        </h1>
        ...
        <div id="kot_header_info" class="fix">
            ...
            <p>Customer: <span id="kot_modal_customer_id" style="display:none;"></span><span
                    id="kot_modal_customer_name"></span></p>
        ...
        <div id="kot_table_content" class="fix">
            <div class="kot_modal_table_content_header fix">
                <div class="kot_header_row fix floatleft kot_check_column"><input type="checkbox" id="kot_check_all">
                </div>
        ...
        <div id="kot_bottom_buttons" class="fix">
            <button id="cancel_kot_modal">Cancel</button>
            <button id="print_kot_modal">Print Kot</button>
        </div>
...
<div id="bot_list_modal" class="modal">
    ...
    <div class="modal-content" id="modal_bot_list_details">
        ...
        <div id="bot_header_info" class="fix">
            ...
            <p>customer: <span id="bot_modal_customer_id" style="display:none;"></span><span
                    id="bot_modal_customer_name"></span></p>
        ...
        <div id="bot_table_content" class="fix">
            <div class="bot_modal_table_content_header fix">
                <div class="bot_header_row fix floatleft bot_check_column"><input type="checkbox" id="bot_check_all">
                </div>
        ...
        <div id="bot_bottom_buttons" class="fix">
            ...
            <button id="print_bot_modal"><?php echo "Print BOT"; ?></button>
        </div>
...
<div id="processing_date_time_modal" class="modal" style="padding-top:20px;">
    ...
    <div class="modal-content" id="">
            ...
            <div class="content">
                ...
                <div class="left-item b">
                    <div class="customer_section fix">
                        ...
                        <input type="datetime-local" class="add_customer_modal_input"
                               id="processing_date_time_modal_input" required>
                    </div>
        ...
        <div class="section7 fix">
            <div class="sec7_inside" id="sec7_2">
                <button id="set_processing_date_time">submit</button>
            </div>
            <div class="sec7_inside" id="sec7_1">
                <button id="close_set_processing_date_time">cancel</button>
            </div>
        </div>
        <!-- <span class="close">&times;</span> -->
        <!-- <p>Some text in the Modal..</p> -->
...
<div id="direct_invoice_button_tool_tip"
     style="display:none;position: absolute;margin-bottom: 15px;background: #fff;border-radius: 5px;box-shadow: 0 1px 5px rgba(0, 0, 0, 0.2);padding:5px;">
    <h1 class="title" style="margin:0px;font-size: 14px;line-height: 25px;">For Fast Food Restaurants</h1>
</div>

<script type="text/javascript" src="<?php echo $baseURL; ?>assets/waiter_panel/js/marquee.js"></script>
<script type="text/javascript" src="<?php echo $baseURL; ?>assets/waiter_panel/js/items.js"></script>
<script type="text/javascript" src="<?php echo $baseURL; ?>assets/waiter_panel/js/datable.js"></script>
<script type="text/javascript" src="<?php echo $baseURL; ?>assets/waiter_panel/js/jquery.cookie.js"></script>
<script type="text/javascript" src="<?php echo $baseURL; ?>assets/waiter_panel/js/howler.min.js"></script>
...
<script type="text/javascript" src="<?php echo $baseURL; ?>assets/waiter_panel/js/custom.js"></script>
