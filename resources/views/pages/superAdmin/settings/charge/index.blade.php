                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body table-responsive">
                            ...
                            <div class="d-flex justify-content-end" style="padding: 10px 0 30px 0">
                                <a role="button" class="btn btn-primary" href="{{route('charges.create')}}">Add
                                    Charge
                                </a>
                            </div>
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <div
                                                        ...
                                                        <a class="dropdown-item edit-link" role="button"
                                                           href="{{route('charges.edit', [$v->id])}}">Edit</a> |
                                                        <a class="dropdown-item" role="button"
                                                           href="{{route('charges.delete', [$v->id])}}">Delete</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
...
@section('script')
    ...
    <script src="{!! $baseURL.'resources/assets/js/custom/superAdmin/charges.js'!!}"></script>
@endsection
