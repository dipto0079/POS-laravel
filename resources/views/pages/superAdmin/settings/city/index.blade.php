                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body table-responsive">
                        ...
                        <div class="d-flex justify-content-end" style="padding: 10px 0 30px 0">
                            <a role="button" class="btn btn-primary" href="{{route('cities.create')}}">Add City
                            </a>
                        </div>
                        <table id="datatable" class="table table-striped">
                            ...
                            <tr>
                                ...
                                <th class="title" style="width: 25%">State</th>
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-lg-left">
                                                    <a class="dropdown-item edit-link" role="button"
                                                       href="{{route('cities.edit', [$v->id])}}">Edit</a> |
                                                    <a class="dropdown-item" role="button"
                                                       href="{{route('cities.delete', [$v->id])}}">Delete</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
...
@section('script')
    ...
    <script src="{!! $baseURL.'resources/assets/js/custom/superAdmin/cities.js'!!}"></script>
@endsection
