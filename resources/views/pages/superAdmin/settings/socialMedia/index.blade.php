                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body table-responsive">
                            ...
                            <div class="d-flex justify-content-end" style="padding: 10px 0 30px 0">
                                <a role="button" class="btn btn-primary" href="{{route('social-media.create')}}">Add
                                    Social Media
                                </a>
                            </div>
                            <table id="datatable" class="table table-striped ">
                                ...
                                @if(count($socialMediaList) > 0)
                                    @foreach($socialMediaList as $k=>$v)
                                        <tr>
                                            <th scope="row">{{$k + 1}}</th>
                                            <td>{{$v->name}}</td>
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <div
                                                        ...
                                                        <a class="dropdown-item edit-link" role="button"
                                                           href="{{route('social-media.edit', [$v->id])}}">Edit</a> |
                                                        <a class="dropdown-item" role="button"
                                                           href="{{route('social-media.delete', [$v->id])}}">Delete</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
...
@section('script')
    ...
    <script src="{!! $baseURL.'resources/assets/js/custom/superAdmin/socialMedia.js'!!}"></script>
@endsection
